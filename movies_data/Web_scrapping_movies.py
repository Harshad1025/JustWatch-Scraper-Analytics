...
try:
    ...
    driver.get('https://www.justwatch.com/in/search?content_type=movie')
    ...
    for container in containers:
        ...
        # Extract movie link
        link_ = ""
        movie_link_elem = container.find('div', class_="title-list-row__column")
        anchor_elem = movie_link_elem.find('a')
        if anchor_elem:
            link_ = anchor_elem.get('href')
        movie_links.append(link_)
